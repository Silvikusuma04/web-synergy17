    ...
    >
      <div className="container mx-auto px-6">
        ...
        <p className="text-center max-w-4xl mx-auto text-deep-sea-blue/80 mb-12">
          This map displays the health status of mangroves at various monitoring points, with the Mangrove Health Index (MHI). Although the general condition is moderate to good, this map helps us identify and prioritize areas requiring rehabilitation. Click on any point to view its MHI data.
        </p>
